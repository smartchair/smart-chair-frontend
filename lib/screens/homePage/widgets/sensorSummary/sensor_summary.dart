...
class _SensorSummaryPageState extends State<SensorSummaryPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 100), () {
      currentChairDataStore.getAllTempCurrentChair(chairStore.selectedChair);
      currentChairDataStore.getAllLumCurrentChair(chairStore.selectedChair);
      currentChairDataStore.getAllHumCurrentChair(chairStore.selectedChair);
      currentChairDataStore.getAllNoiseCurrentChair(chairStore.selectedChair);
    });
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text("Média Luminosidade: ", style: TextStyle(fontSize: 20)),
                  Observer(builder: (_) {
                    if (currentChairDataStore.loading) {
                      return shimmerWidget();
                    } else {
                ...
                children: [
                  ...
                  Observer(builder: (_) {
                    if (currentChairDataStore.loading) {
                      ...
                      return dataSensors(currentChairDataStore.averageHum, "%");
                    }
                  }),
                ],
              ),
